...
{
    return CGSizeMake(self.sliderCellSize, self.sliderCellSize);
}
...
{
    return CGRectMake((self.sliderCellSize - 114.0f) / 2.0, (self.sliderCellSize - 114.0f) / 2.0 - 10.0f, 114.0f, 114.0f);
}
...
{
    NSRect rect = NSMakeRect(0.0f, 0.0f, self.sliderCellSize, self.sliderCellSize);
